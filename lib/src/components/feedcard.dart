...
class _ItemCardState extends State<ItemCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Get.to(() => DetailPage(item: widget.item));
      },
      child: Container(
        width: double.maxFinite,
        height: 350,
        decoration: BoxDecoration(color: const Color.fromARGB(35, 255, 161, 236), borderRadius: BorderRadius.circular(10)),
        child: Column(children: [
          Stack(children: [
            InkWell(borderRadius: BorderRadius.circular(10), child: ClipRRect(borderRadius: BorderRadius.circular(10.0), child: Container(decoration: const BoxDecoration(), child: Image.asset(widget.item.imgUrl)))),
            Positioned(
                top: 10,
                right: 10,
                child: InkWell(
          ...
          Row(
            ...
            children: [
              ...
              OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(minimumSize: const Size(90, 38), foregroundColor: Colors.red, side: const BorderSide(width: 1, color: Colors.red)),
